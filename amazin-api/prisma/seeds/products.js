    ...
    categories: [
      {
        ...
        products: [
          ...
          },
          {
            ...
            categoryId: 4,
            isOnSale: true,
            discountPercent: Math.floor(Math.random() * 6) * 5 + 10,
      ...
      },
      {
        ...
        products: [
          ...
          },
          {
            ...
            price_cents: 999,
            description:
              "These storage containers are perfect for organizing your home. They're made of durable plastic and come in a variety of colors to match any decor.",
            image:
              'https://images.unsplash.com/photo-1576083983581-091fe917ff9d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1674&q=80',
            quantity: 20,
            categoryId: 8,
            isOnSale: true,
            discountPercent: Math.floor(Math.random() * 6) * 5 + 10,
      ...
      },
      {
        ...
        products: [
          ...
          },
          {
            ...
            image:
              'https://images.unsplash.com/photo-1541963463532-d68292c34b19?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=776&q=80',
            quantity: 15,
            categoryId: 12,
            userId,
            quantitySold: Math.floor(Math.random() * 100) + 1,
    ...
    categories: [
      {
        ...
        products: [
          {
            name: 'Amazin Gift Card $100',
            price_cents: 10000,
            description:
              'Amazin Gift Card is the perfect gift for any occasion. It can be used to buy anything on Amazin, including books, electronics, and more.',
            image: 'https://images.unsplash.com/photo-1526614180703-827d23e7c8f2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1035&q=80',
            quantity: 100,
            categoryId: 1,
            userId: 1,
            quantitySold: 0,
